...
128 heaps should be the maximum we allow. Aim for something slightly under
  // that. For example, make recommendedMaxWorkingSetSize/128 the size of a
  // small heap in a PyTorch-like allocator. Sometimes heaps will be larger,
  // meaning
