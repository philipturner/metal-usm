...
- Default - assumes most computations use device memory. 0.5 cycle penalty for every memory access, except first 30 pointers captured as lambda arguments in SYCL C++ source.
