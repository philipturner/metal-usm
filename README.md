...
TODO: Pitch this concern to the SYCL maintainers, ask about expectations for performance of USM. Is 2 GB enough for a typical GPU program, even when 32 GB of physical and 1000 GB of virtual RAM are possible? Do I want to take away access to the M1 GPU's massive virtual memory pool, or is it okay to just use SYCL accessors for that purpose?
